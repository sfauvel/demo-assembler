...
write_given_file_with_alphabet:
        ...
        section   .data
file_to_read:    db "../../work/demo_read_data.txt", 0
file_to_write:   db "../../work/demo_write_data.txt", 0
alphabet:        db "ABCDEFGHIJKLMNOPQRSTUVWXYZ", 0
current_length:  dq 0
buffer_head:     dq 0
buflen:          dw 20000 ; Size of our buffer to be used for read
file_descriptor: dq 0

        section .bss
current_char:    resb 1
buffer:          resb 20000 ; A 2 KB byte buffer used for read
short_buffer:    resb 20000 ; A 2 KB byte buffer used for read