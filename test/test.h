...
#define _assertStringEq(expected, actual) do { char* actualValue=actual; if (strcmp(expected, actualValue)!=0) { FAIL(); printf(", Expected: %s but %s", expected, actualValue);return; } } while(0)
